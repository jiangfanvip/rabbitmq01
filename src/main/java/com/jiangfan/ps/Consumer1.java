...
public class Consumer1 {
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //声明交换机
        channel.exchangeDeclare(Producer.exchange1, BuiltinExchangeType.FANOUT);
        //队列绑定交换机
        channel.queueBind(Producer.QUEUE_NAME1, Producer.exchange1, "");
        //创建消费者
        ...
        //参数3 消费者对象
        channel.basicConsume(Producer.QUEUE_NAME1, true, defaultConsumer);
