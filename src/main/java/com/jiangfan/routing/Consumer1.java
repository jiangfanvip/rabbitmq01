...
public class Consumer1 {
    public static void main(String[] args) throws IOException, TimeoutException {
      ...
      ///  channel.exchangeDeclare(Producer.DIRECT_EXCHANGE, BuiltinExchangeType.DIRECT);
         //访问队列
        //hannel.queueDeclare(Producer.QUEUE_INSERT, true, false, false, null);


        //队列绑定交换机  //参数1  routing key   参数2  交换机  参数3    绑定的routing key
        channel.queueBind(Producer.QUEUE_INSERT, Producer.DIRECT_EXCHANGE, "insert");
        //创建消费者
        ...
        //参数3 消费者对象
        channel.basicConsume(Producer.QUEUE_INSERT, true, defaultConsumer);
